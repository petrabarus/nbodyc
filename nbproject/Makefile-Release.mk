...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-Release.mk dist/Release/MinGW-Windows/nbodyc.exe
...
${OBJECTDIR}/src/nbody/direct/direct.o: src/nbody/direct/direct.c 
	...
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nbody/direct/direct.o src/nbody/direct/direct.c

${OBJECTDIR}/src/options.o: src/options.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/options.o src/options.c

${OBJECTDIR}/src/nbody.o: src/nbody.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nbody.o src/nbody.c

${OBJECTDIR}/src/nbody/barneshut/barneshut.o: src/nbody/barneshut/barneshut.c 
	${MKDIR} -p ${OBJECTDIR}/src/nbody/barneshut
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nbody/barneshut/barneshut.o src/nbody/barneshut/barneshut.c

${OBJECTDIR}/src/io/vtk/vtk.o: src/io/vtk/vtk.c 
	${MKDIR} -p ${OBJECTDIR}/src/io/vtk
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/io/vtk/vtk.o src/io/vtk/vtk.c

${OBJECTDIR}/src/nbody/fmm/fmm.o: src/nbody/fmm/fmm.c 
	${MKDIR} -p ${OBJECTDIR}/src/nbody/fmm
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nbody/fmm/fmm.o src/nbody/fmm/fmm.c

${OBJECTDIR}/src/particle.o: src/particle.c 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/particle.o src/particle.c

${OBJECTDIR}/src/utils/util.o: src/utils/util.c 
	${MKDIR} -p ${OBJECTDIR}/src/utils
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/utils/util.o src/utils/util.c

${OBJECTDIR}/src/nbody/barneshut/treecode.o: src/nbody/barneshut/treecode.c 
	${MKDIR} -p ${OBJECTDIR}/src/nbody/barneshut
	${RM} $@.d
	$(COMPILE.c) -O2 -Werror -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/nbody/barneshut/treecode.o src/nbody/barneshut/treecode.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	${RM} -r build/Release
	${RM} dist/Release/MinGW-Windows/nbodyc.exe
